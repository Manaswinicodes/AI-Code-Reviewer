...
if not API_KEY:
    st.error(" API Key not found. Please set it as an environment variable (e.g., GOOGLE_API_KEY).")
    st.stop()
...
        return response.text.strip() if response.text else " No response received from AI. Try again."
